                    ...
                    <div className='row align-items-center'>
                        ...
                        <div className='col-12 col-sm-12 col-md-6 col-lg-6'>
                            <div className='great-earning-img'>
                                <img src='Assets/Images/great_earning.png' alt='Gift' className='w-85' />
                    ...
                    <div className='row align-items-center'>
                        <div className='col-12 col-sm-12 col-md-12 col-lg-5'>
                            <div className='about-img'>
                                <img src='Assets/Images/about_bwc.png' alt='Gift' className='w-100' />
                            </div>
                        </div>
                    ...
                    <div className='row align-items-center'>
                        <div className='col-12 col-sm-12 col-md-12 col-lg-7'>
                            <div className='relaxation-content text-start ms-5'>
                                <h3 className="font-36 pb-3 text-white">Why choose Dr. BWC Relax Zone</h3>
                                ...
                                <p className='font-16 text-white'>Dr. BWC gives you an opportunity get respected status as well as handsome earnings in just a small investment and minimal training.</p>
                        ...
                        <div className='col-12 col-sm-12 col-md-12 col-lg-5'>
                            <div className='relaxation-img'>
                                <img src='Assets/Images/relax_zone_img.png' alt='Gift' className='w-100' />
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <section className='need-relaxation mt-5 mb-5'>
                <div className='container'>
                    <div className='row align-items-center'>
                        ...
                        <div className='col-12 col-sm-12 col-md-12 col-lg-5'>
                            <div className='relaxation-img'>
                                <img src='Assets/Images/need_relaxation.png' alt='Gift' className='w-100' />
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div className='container'>
                        <div className='row align-items-center'>
                            <div className='col-12 col-sm-12 col-md-4 col-lg-4'>
                                <div className='relaxation-card'>
                                    <div className='relaxation-card-img'>
                                        <img src='Assets/Images/relaxation_one.svg' alt='Relaxation Card' />
                                    </div>
                            ...
                            <div className='col-12 col-sm-12 col-md-4 col-lg-4'>
                                <div className='relaxation-card'>
                                    <div className='relaxation-card-img'>
                                        <img src='Assets/Images/relaxation_two.svg' alt='Relaxation Card' />
                                    </div>
                                    <div className='relaxation-card-body'>
                                        <ul>
                            ...
                            <div className='col-12 col-sm-12 col-md-4 col-lg-4'>
                                <div className='relaxation-card'>
                                    <div className='relaxation-card-img'>
                                        <img src='Assets/Images/relaxation_three.svg' alt='Relaxation Card' />
                                    </div>
                                    <div className='relaxation-card-body'>
                                        <ul>
