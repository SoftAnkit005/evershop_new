            ...
            <div className='login-wrapper'>
              <div className='w-100'>
                <div className='text-center'>
                  ...
                  <p className='text-center font-16 text-white fw-lighter mt-4'>don it have an  account? <a href={registerUrl} className='ms-1 text-white text-decoration-none fw-bold' >register</a></p>
                </div>
              </div>
            </div>
          </div>
