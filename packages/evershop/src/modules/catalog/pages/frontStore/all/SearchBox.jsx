      ...
      {showing && (
        <div className="search-input-container">
          <div className="search-input">
            <a href="#" className="close-icon" style={{width:'22px'}} onClick={(e) => { e.preventDefault(); setsearchList([]); setKeyword(null); InputRef.current.value = "" }} aria-label="Close" > <XIcon className='fs-2 text-white' /> </a>
            <Input
