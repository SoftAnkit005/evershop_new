            ...
            <div className='p-80'>
                <div className='container row m-auto'>
                    <div className='col-sm-12 col-lg-6 d-flex flex-column justify-content-center'>
                        <h2 className='doc-name-white fw-bold'>WHY DR.BWC?</h2>
                        <p className='products-details-white me-5'>Our goal is to create the highest degree of luxury with the health benefit of our Massage Equipment in your daily life. Set up in India, Dr.BWC has a prominent background and an enriched experience in the massage machine.</p>
                    </div>
                    <div className='col-sm-12 col-lg-6 row'>
                        <div className='col-12 col-sm-12 col-md-12 col-lg-6'>
                            <div className='products-info'>
                                <h1 className='about-title'>01</h1>
                                <p className='products-details-white text-start pb-0'>A premium product crafted with highest stature and quality.</p>
                            </div>
                        </div>
                        ...
                        <div className='col-12 col-sm-12 col-md-12 col-lg-6 mt-5'>
                            <div className='products-info'>
                                ...
                                <p className='products-details-white text-start pb-0'>With the world-class massage chairs that avail you with superior relaxation.</p>
                            </div>
                        </div>
                        <div className='col-12 col-sm-12 col-md-12 col-lg-6 mt-5'>
                            <div className='products-info'>
