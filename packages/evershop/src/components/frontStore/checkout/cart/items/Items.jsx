...
function Items({ items, setting: { displayCheckoutPriceIncludeTax } }) {
  ...
  return (
    <div id="shopping-cart-items" className='table-responsive'>
            ...
            <tr key={index}>
              <td>
                <div className="d-flex align-items-center">
                  <div className="product-image flex justify-center items-center mt-4">
                    {item.thumbnail && (
                      <img
                  ...
                  <div className="cart-tem-info ms-3">
                    <a
              ...
              <td>
                {item.finalPrice.value < item.productPrice.value && (
                  <div>
                    <span className="regular-price text-black">
